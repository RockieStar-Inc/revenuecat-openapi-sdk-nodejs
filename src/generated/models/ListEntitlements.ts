 ...
 */
export function instanceOfListEntitlements(value: object): value is ListEntitlements {
...
export function ListEntitlementsToJSON(json: any): ListEntitlements {
    return ListEntitlementsToJSONTyped(json, false);
}

export function ListEntitlementsToJSONTyped(value?: ListEntitlements | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
