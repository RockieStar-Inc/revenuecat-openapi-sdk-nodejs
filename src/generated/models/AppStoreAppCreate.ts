 ...
 */
export function instanceOfAppStoreAppCreate(value: object): value is AppStoreAppCreate {
    return true;
}
...
export function AppStoreAppCreateToJSON(json: any): AppStoreAppCreate {
    return AppStoreAppCreateToJSONTyped(json, false);
}

export function AppStoreAppCreateToJSONTyped(value?: AppStoreAppCreate | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
