 ...
 */
export function instanceOfPackageProductAssociation(value: object): value is PackageProductAssociation {
...
export function PackageProductAssociationToJSON(json: any): PackageProductAssociation {
    return PackageProductAssociationToJSONTyped(json, false);
}

export function PackageProductAssociationToJSONTyped(value?: PackageProductAssociation | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
