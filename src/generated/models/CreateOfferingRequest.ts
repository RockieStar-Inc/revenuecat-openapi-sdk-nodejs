 ...
 */
export function instanceOfCreateOfferingRequest(value: object): value is CreateOfferingRequest {
...
export function CreateOfferingRequestToJSON(json: any): CreateOfferingRequest {
    return CreateOfferingRequestToJSONTyped(json, false);
}

export function CreateOfferingRequestToJSONTyped(value?: CreateOfferingRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
