 ...
 */
export function instanceOfAmazonAppCreateAmazon(value: object): value is AmazonAppCreateAmazon {
...
export function AmazonAppCreateAmazonToJSON(json: any): AmazonAppCreateAmazon {
    return AmazonAppCreateAmazonToJSONTyped(json, false);
}

export function AmazonAppCreateAmazonToJSONTyped(value?: AmazonAppCreateAmazon | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
