 ...
 */
export function instanceOfAmazonApp(value: object): value is AmazonApp {
    return true;
}
...
export function AmazonAppToJSON(json: any): AmazonApp {
    return AmazonAppToJSONTyped(json, false);
}

export function AmazonAppToJSONTyped(value?: AmazonApp | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
