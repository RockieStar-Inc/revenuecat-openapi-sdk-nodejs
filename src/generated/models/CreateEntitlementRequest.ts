 ...
 */
export function instanceOfCreateEntitlementRequest(value: object): value is CreateEntitlementRequest {
...
export function CreateEntitlementRequestToJSON(json: any): CreateEntitlementRequest {
    return CreateEntitlementRequestToJSONTyped(json, false);
}

export function CreateEntitlementRequestToJSONTyped(value?: CreateEntitlementRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
