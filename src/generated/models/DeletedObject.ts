 ...
 */
export function instanceOfDeletedObject(value: object): value is DeletedObject {
...
export function DeletedObjectToJSON(json: any): DeletedObject {
    return DeletedObjectToJSONTyped(json, false);
}

export function DeletedObjectToJSONTyped(value?: DeletedObject | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
