...
import {
    ...
    PackageProductIDAssociationToJSONTyped,
 ...
 */
export function instanceOfAttachProductsToPackageRequest(value: object): value is AttachProductsToPackageRequest {
...
export function AttachProductsToPackageRequestToJSON(json: any): AttachProductsToPackageRequest {
    return AttachProductsToPackageRequestToJSONTyped(json, false);
}

export function AttachProductsToPackageRequestToJSONTyped(value?: AttachProductsToPackageRequest | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
