 ...
 */
export function instanceOfUpdateAppRequestAppStore(value: object): value is UpdateAppRequestAppStore {
    return true;
}
...
export function UpdateAppRequestAppStoreToJSON(json: any): UpdateAppRequestAppStore {
    return UpdateAppRequestAppStoreToJSONTyped(json, false);
}

export function UpdateAppRequestAppStoreToJSONTyped(value?: UpdateAppRequestAppStore | null, ignoreDiscriminator: boolean = false): any {
    if (value == null) {
        return value;
    }
